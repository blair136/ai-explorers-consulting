...
const days = [
  {
    ...
    subtitle: 'Idee schärfen, validieren — und direkt die ersten Apps bauen. Mit Base44 kommen alle sofort ins Tun.',
    agenda: [
      { type: 'Impulsvortrag', items: ['Was ein digitales Produkt wirklich auszeichnet', 'Der Innovationsprozess — von Design Thinking bis Product Development', 'KI & Datenschutz: DSGVO-konforme KI-Nutzung im Unternehmen'] },
      { type: 'Methoden & Übungen', items: ['Ideen strukturiert ausarbeiten: Problem Statements, How Might We', 'Nutzer verstehen, Insights sammeln, Value Proposition schärfen', 'Product Canvas: MVP definieren und priorisieren', 'Annahmen identifizieren und validieren'] },
      { type: 'Erste Umsetzung mit Base44', items: ['Einführung in Base44 — vom Prompt zur laufenden App', 'Erste einfache Apps gemeinsam bauen und ausprobieren', 'Schnell iterieren: Feedback einbauen, Ideen testen'] },
    ],
  },
  {
    day: 'Tag 2',
    ...
    subtitle: 'Claude Code wird installiert, eingerichtet und direkt für das eigene Hauptprojekt eingesetzt.',
    agenda: [
      { type: 'Impulsvortrag', items: ['Was gutes digitales Design ausmacht — Prinzipien, Quellen, Inspiration (Mobbin, Dribbble, Style Guides)', 'API-Schnittstellen verstehen: Was sind APIs und wie bindet man sie ein?', 'Base44 vs. Claude Code: Wann was sinnvoll ist'] },
      { type: 'Claude Code Setup', items: ['Claude Code installieren und konfigurieren', 'Skills und Extensions einrichten', 'Erste Schritte und Workflows verstehen'] },
      { type: 'Projekt-Umsetzung', items: ['Eigene App-Idee mit Claude Code aufsetzen', 'Projektstruktur anlegen und erste Features bauen', 'Externe APIs und Services anbinden'] },
    ],
  },
  {
    day: 'Tag 3',
    ...
    subtitle: 'Das eigene Projekt wird weiterentwickelt, verfeinert und abgeschlossen — mit Pitch und Zertifikat.',
    agenda: [
      { type: 'Vertiefung', items: ['Fortgeschrittene Claude-Code-Workflows', 'Qualitätssicherung: Wie erkenne ich gute von schlechten KI-Outputs?', 'Q&A und individuelle Problemlösungen mit den Trainern'] },
      { type: 'Abschlussprojekt', items: ['App weiterentwickeln und finalisieren', 'Persönliche KI-Roadmap aus dem Workbook ableiten', 'Abschlusspräsentation und Team-Pitch', 'Zertifikatsübergabe & Ausblick'] },
    ],
  },
];
